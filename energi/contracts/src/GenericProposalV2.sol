...
/**
 * Genesis hardcoded version of GenericProposal V2
 *
 * NOTE: it MUST NOT change after blockchain launch!
 */
contract GenericProposalV2 is
    GlobalConstants,
    IProposal
{
    ...
    // supermajority defines the majority percentage that determines proposal acceptance
    ...
    function isAccepted() public view returns(bool) {
        ...
        // Acceptance determined by supermajority
        return accepted_weight > quorum_weight * supermajority / 100;
    }
