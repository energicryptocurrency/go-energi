...
func (w *wizard) run() {
	fmt.Println("+-----------------------------------------------------------+")
	fmt.Println("| Welcome to puppeth, your Energi private network manager |")
	fmt.Println("|                                                           |")
	fmt.Println("| This tool lets you create a new Energi network down to  |")
	...
	log.Info("Administering Energi network", "name", w.network)
