...
//
// # go test -benchmem -run=none github.com/energicryptocurrency/energi/swarm/storage/localstore -bench BenchmarkRetrievalIndexes -v
// goos: darwin
// goarch: amd64
// pkg: github.com/energicryptocurrency/energi/swarm/storage/localstore
...
//
// go test -benchmem -run=none github.com/energicryptocurrency/energi/swarm/storage/localstore -bench BenchmarkUpload -v
// goos: darwin
// goarch: amd64
// pkg: github.com/energicryptocurrency/energi/swarm/storage/localstore
