...
The dashboard is a data visualizer integrated into energi3, intended to collect and visualize useful information of an Energi node. It consists of two parts:
...
```
$ energi3 --dashboard --vmodule=dashboard=5
